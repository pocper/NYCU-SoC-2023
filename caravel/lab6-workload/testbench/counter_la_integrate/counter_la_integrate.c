...
void main()
{
	...
	reg_mprj_datal = 0xAB000000; // Start Task

	int *tmp;
	// Matrix Multiplication
	reg_mprj_datal = 0xAB110000; // Start Flag
	tmp = matmul();
	for(int i=0;i<16;i=i+1){
        reg_mprj_datal = *(tmp+i) << 16; // matmul[i]
    }
    
	reg_mprj_datal = 0xAB190000; // End Flag

	// Quick Sort
	reg_mprj_datal = 0xAB210000; // Start Flag
	tmp = qsort();
	...
	reg_mprj_datal = 0xAB290000; // End Flag

	// FIR
	reg_mprj_datal = 0xAB310000; // Start Flag
	tmp = fir();
	reg_mprj_datal = *tmp << 16;
	reg_mprj_datal = *(tmp+1) << 16;
	reg_mprj_datal = *(tmp+2) << 16;
	...
	reg_mprj_datal = 0xAB390000; // End Flag

    reg_mprj_datal = 0xAB400000; // End Task
}
